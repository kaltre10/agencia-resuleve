...
const HeroSection = () => {
  ...
  const trustBadges = [
    ...
    { icon: DollarSign, label: 'Mínima', value: `Desde ${settings.minTicketPrice} Bs`, color: 'text-accent' },
    { icon: Zap, label: 'Trayectoria', value: '+5 Años', color: 'text-primary' },
  ];

  return (
    <section className="relative w-full px-3 sm:px-6 lg:px-8 pt-2 pb-6 lg:pt-4 lg:pb-10 bg-surface">
            ...
            >
              ...
              <div className="flex flex-col text-left">
                ...
                <span className="text-[10px] sm:text-sm text-on-primary-container font-semibold opacity-90 mt-0.5">
                  Atención en vivo • Respuesta inmediata
                </span>
              </div>
        ...
        <div className="lg:col-span-5 flex flex-col items-center justify-center relative">
          <div className="relative w-full max-w-md p-6 sm:p-8 rounded-2xl bg-surface-container shadow-2xl flex flex-col items-center text-center">
            ...
            <div className="relative z-10 w-full flex flex-col items-center">
              ...
              <span className="text-xl font-bold text-on-surface uppercase tracking-tight">Sorteos de Hoy</span>
              <p className="text-sm text-on-surface-variant mt-1 mb-4">
                Lotto Activo • La Granjita • Triples Nacionales
              </p>

              {/* <div className="w-full p-4 rounded-xl bg-surface-container-low flex items-center justify-between shadow-inner">
                <div className="flex flex-col text-left">
                  <span className="text-xs text-on-surface-variant uppercase font-bold">Próximo Cierre</span>
                  <span className="text-sm font-bold text-on-surface">Lotto Activo 12:00 PM</span>
                </div>
                <div className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-secondary-container text-on-secondary-container text-sm font-bold animate-pulse">
                  ⏰ {formatTime(timer)}
                </div>
              </div> */}
