...
const Footer = () => {
  ...
  return (
    <footer className="w-full px-4 sm:px-6 lg:px-8 py-12 bg-surface-container-lowest border-t border-surface-container-highest">
      <div className="max-w-7xl mx-auto flex flex-col gap-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col gap-3">
            ...
            <p className="text-xs text-on-surface-variant leading-relaxed">
              Agencia oficial de apuestas loteriles en Venezuela. Más de 5 años de experiencia brindando pagos inmediatos y atención de calidad.
            </p>
          </div>

          <div className="flex flex-col gap-3">
            <span className="text-xs text-on-surface uppercase font-bold">Loterías Disponibles</span>
        ...
        <div className="border-t border-surface-container-highest pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <span className="text-xs text-on-surface-variant">
            © 2024 {settings.appName}. Todos los derechos reservados.
          </span>
