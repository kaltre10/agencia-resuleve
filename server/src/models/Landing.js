...
const landingSchema = new mongoose.Schema({
  settings: {
    ...
    footerDescription: { type: String, default: 'Agencia oficial de loteria y animalitos en Venezuela. Mas de 5 anos de experiencia brindando pagos inmediatos, loterias nacionales y atencion de calidad 24/7.' },
    termsUrl: { type: String, default: '' },
    privacyUrl: { type: String, default: '' },
    responsibleUrl: { type: String, default: '' },
  },
